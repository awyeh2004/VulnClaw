...
def _system_prompt(agent: AgentContext, state: AgentState) -> str:
    ...
    return (
        ...
        "Prioritize cheap web-layer attack surface before deep analysis of single assets: "
        "enumerate open dirs and endpoints, probe directory traversal/parent-dir variants, "
        "and look for backup/source leaks first; only dive into steganography/forensics of a "
        "large static file (image/audio/archive) after web-layer paths are exhausted.\n"
